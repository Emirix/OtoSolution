...
function Add() {
    ...
    return (
        <div className="p-3">
            ...
            <div className="r-a__caption">To pair Oto-Link with the car follow the steps below.</div>
            <div className="row">
                <div className="col-12 col-lg-6">
                <div className="scanner br-12 mt-4 ">
                <div className="r-a__caption">1. Scan&nbsp;<b> SKU barcode</b>&nbsp; on the car or type in manually</div>
                ...
                <div className="col-12 col-lg-6">
                <div className="scanner br-12 mt-4 ">
                <div className="r-a__caption">2. Scan&nbsp;<b>QR Code</b>&nbsp;on the OBD or type in manually</div>
                <div className="scanner__content">
